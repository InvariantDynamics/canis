...
By enabling this toolset, Canis will be able to fetch metadata from Kafka. This provides Canis the ability to introspect into Kafka by listing consumers and topics or finding lagging consumer groups.
...
|------------|-------------|
| name | Give a meaningful name to your cluster. Canis will use it to decide what cluster to look into. Names must be unique across all clusters. |

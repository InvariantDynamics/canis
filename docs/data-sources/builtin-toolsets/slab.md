...
By enabling this toolset, Canis will be able to consult runbooks from Slab pages.
...
```bash
canis ask "Why is my pod failing, if it's a crashloopbackoff use the runbooks from Slab"
```
